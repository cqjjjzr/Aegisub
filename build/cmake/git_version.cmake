...
if(GIT_FOUND)
    ...
    message(STATUS "Aegisub Build: Git not found...")
...
if(NOT "${NO_GENERATE_GIT_VERSION_H}" STREQUAL "YES")
    message(STATUS "Aegisub Build: Configuring git_version.h")
    configure_file("${PROJECT_SOURCE_DIR}/build/cmake/git_version.h.in" "${PROJECT_SOURCE_DIR}/src/generated/git_version.h")
endif()
